...
const STEPS: { query: string; hl: string[] }[] = [
  { query: "vendor invoice from Ironclad Hardware for the June order", hl: ["type", "date", "party"] },
  { query: "our office electric bill from last quarter", hl: ["type", "party"] },
  { query: "receipt for the laptop I expensed at Best Buy", hl: ["party", "type"] },
  { query: "show me invoices under $3,000", hl: ["amount", "type"] },
  { query: "the FedEx bill for the Denver shipment", hl: ["party", "type"] },
  { query: "bills from June 2026", hl: ["type", "date"] },
  { query: "client invoices over $50,000", hl: ["amount", "type"] },
];
